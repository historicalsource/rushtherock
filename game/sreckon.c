 ...
 *
 *	======================================================================
 *	$Author: geraci $						$Date: 1997/03/13 03:58:29 $
 *	$Revision: 3.24 $						$Locker:  $
 *	======================================================================
 *	Change Log:
 *
 *	$Log: reckon.c,v $
...
#if 0
	/* force update for first 5 secs of race */
#if 0
	if ((slot == gThisNode) || (GetElapsedTime() < ONE_SEC/2))
		return 1;
#else
	if (GetElapsedTime() < ONE_SEC/2)
		return 1;
#endif
#endif
