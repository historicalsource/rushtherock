 ...
 *
 *	======================================================================
 *	$Author: gray $						$Date: 1997/10/12 07:55:24 $
 *	$Revision: 3.43 $						$Locker:  $
 *	======================================================================
 *	Change Log:
 *
 *	$Log: modeldat.h,v $
 * Revision 3.43  1997/10/12  07:55:24  gray
 * Brute force method to make sure gameover times are send and received.
 * Should be rolled into gamenet later.
 *
 * Revision 3.42  1997/06/04  02:15:46  gray
 * Restructuring controls (gas,brake,clutch,etc) handling.
 *
 * Revision 3.41  1997/05/30  18:21:07  gray
 * Pruning mainin.
 *
 * Revision 3.40  1997/05/30  07:53:15  gray
 * fastout is history.
 *
 ...
 *
 * Revision 3.37  1997/05/29  21:08:03  gray
 * Clean up mph stuff.
 *
 * Revision 3.36  1997/05/21  22:11:28  gray
 * road codes removed from mainout.
 *
 * Revision 3.35  1997/05/21  18:13:16  gray
 * Removed rollv, pitchv, and yawv from mainout.
 *
 * Revision 3.34  1997/05/21  06:04:56  gray
 * Killed xv,yv,zv in mainout (again).
 *
 * Revision 3.33  1997/05/21  00:10:16  gray
 * caruvs finally exterminated.
 *
 * Revision 3.32  1997/05/13  22:54:50  gray
...
/* Car and world constants */
	...
	S32 		iter;
	S32 		crashflag;	/* flag we've crashed */
...
/* Scattered Vars */
	...
	F32		mph;	/* Speedometer reading (rear wheels) */
