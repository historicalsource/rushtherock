 ...
 *
 *	======================================================================
 *	$Author: gray $						$Date: 1997/09/02 00:16:57 $
 *	$Revision: 3.25 $						$Locker:  $
 *	======================================================================
 *	Change Log:
 *
 *	$Log: cpinit.c,v $
...
/*InitCheckPoint * const InitCP_Track[NTRACKS*2] =*/
InitCheckPoint * const InitCP_Track[NTRACKS*4] =
{
/* normal set 1 (T1 - T4) */
...
/*const Init_Track_Data init_track_data[NTRACKS*2] =*/
const Init_Track_Data init_track_data[NTRACKS*4] =
{
/* normal set 1 (T1 - T4) */
/*	 |------ start_time[diff] ------|,|-------- end_time[diff] ------|,loop, fin, b4fin */
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   2,   4,   3},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   5},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   8},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   1,   1,   7},
/* normal set 2 (T5 - T8) */
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   3},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   3},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   5},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   5},
/*backward set 2 (for consumer tracks only) */
...
/*backward set 1 (for consumer tracks only) */
	...
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   5},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   8},
	{{60, 60, 60, 60, 60, 60, 60, 60},{90, 60, 40, 30, 20, 15, 10,  5},   0,   0,   4},
