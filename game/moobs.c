 ...
 *
 *  ======================================================================
 *  $Author: gray $                       $Date: 1997/10/14 02:51:12 $
 *  $Revision: 3.36 $                       $Locker:  $
 *  ======================================================================
 *  Change Log:
 *
 *  $Log: moobs.c,v $
 * Revision 3.36  1997/10/14  02:51:12  gray
 * if'ed out broken aud_qlen call in switch 3 debug.
 *
 * Revision 3.35  1997/10/09  06:00:18  hightower
 * Prevent waiting for drivers between tourney and non-tourney
 *
 * Revision 3.34  1997/10/01  03:44:16  grjost
 * Fixed sounds for mirror tracks
 *
 * Revision 3.33  1997/09/30  02:20:26  grjost
 * Added new sounds.
 *
 * Revision 3.32  1997/09/25  02:08:32  grjost
 * Added new sounds for tracks
 *
 * Revision 3.31  1997/09/13  01:48:28  grjost
 * Added sounds for track 4
 *
 * Revision 3.30  1997/09/05  00:57:41  gray
 * Removed test yell from T4.
 *
 * Revision 3.29  1997/09/04  18:24:10  gray
...
const MISC_SOUND misc_sound_tab[] =
{
    ...
    {S_ITSINSANE,  S_KFOGHORN,  0, {  381,-149, -1632}, 110*110},
    {S_BADLICIOUS, S_KFOGHORN,  0, {  808, -68,  1844}, 150*150},
    {S_ITSFAT,     S_KFOGHORN,  0, {-2053,  44, -2330}, 180*180},
    ...
    {S_YELL,       S_KPARKBIRD, 1, { 1143,  48,  2317}, 60*60},
    {S_BADLICIOUS, S_KPARKBIRD, 1, {-6360,  70,  2763}, 160*160},
    {S_CHIPS,      S_KPARKBIRD, 1, {-8021, 132,  3449}, 160*160},
    {S_LOOKOUT,    S_KPARKBIRD, 1, {-2980, 108,   -62}, 160*160},
    {S_LOOKOUT,    S_KFOGHORN,  2, {-5216,  29,   317}, 160*160},
    {S_ITSINSANE,  S_KFOGHORN,  2, {-7275, 220,  2182}, 220*220},
    {S_ITSFAT,     S_KFOGHORN,  2, {-2261, 486,  3745}, 140*140},
    {S_YOUGOTTA,   S_KFOGHORN,  2, {-1472, 237,  1829}, 180*180},
    {S_YELL,       S_KFOGHORN,  3, {   42, 252, -1633}, 110*110},
    {S_ITSFAT,     S_KFOGHORN,  3, {   55, 556,   -87}, 90*90},
    {S_YOUGOTTA,   S_KFOGHORN,  3, { -704, 230, -1405}, 170*170},
    {S_SEAGULLS,   S_KSEAGULLS, 3, { -561, 314,  -105}, 300*300},
    {S_SEAGULLS,   S_KSEAGULLS, 4, { 4125, 193,  1439}, 450*450},
    {S_YELL,       S_KFOGHORN,  4, { 3895, 146,  1433}, 160*160},
    {S_YOUGOTTA,   S_KFOGHORN,  4, { 1990, 426,  3207}, 180*180},
    {S_LOOKOUT,    S_KFOGHORN,  4, {  346, 240,    71}, 160*160},
    {S_CHIPS,      S_KFOGHORN,  4, { 1482, 244,     9}, 160*160},
    {S_SEAGULLS,   S_KSEAGULLS, 5, { 5226,  27,  2839}, 750*750},
    {S_PARKBIRD,   S_KPARKBIRD, 5, { 4041,  67,   222}, 650*650},
    {S_LOOKOUT,    S_KFOGHORN,  5, { 2207, 183,  4487}, 180*180},
    {S_YELL,       S_KFOGHORN,  5, { -192, 405,   540}, 160*160},
    {S_BADLICIOUS, S_KFOGHORN,  5, { 4710,  16,  2147}, 160*160},
    {S_PARKBIRD,   S_KPARKBIRD, 5, { -140, 533,  4220}, 200*200},
    {S_CROWDSCARE, S_KFOGHORN,  5, { 2000, 275,   -20}, 250*250},
    {S_SEAGULLS,   S_KSEAGULLS, 6, {    0,  80, -2003}, 2800*2800},
};
...
void
UpdateListener (S8 update_car_sounds, S8 skids_only)
{
...
void
add_moob_to_list (S16 moob_sound, F32 * pos, S32 radius)
{
...
void
do_misc_sounds (S32 xpos, S32 ypos, S32 zpos)
{
    S16 i, j;
