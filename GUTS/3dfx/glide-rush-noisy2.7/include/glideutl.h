...
**
** $Header: /engr/devel/sst1/GLIDE/DOS/SRC/GLIDEUTL.H 3     6/10/96 12:08p Dow $
** $Log: /engr/devel/sst1/GLIDE/DOS/SRC/GLIDEUTL.H $
 * 
...
FX_ENTRY void
FX_CALL guDrawPolygonVertexListWithClip( int nverts, const GrVertex vlist[] );
